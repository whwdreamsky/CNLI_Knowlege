...
if __name__ == '__main__':
    ...
    data_base2 = "/home/oliver/Documents/workplace/project/data/snli/snli/"
    data_base1 = "/home/hwwang/workplace/deeplearning/textentailment/data/kim_wordnet_data/"
    # root_base = "/home/hwwang/workplace/deeplearning/textentailment/multiffn-nli-master/"
    data_base = "/home/hwwang/workplace/project/nli/data/word_sequence/"
    ...
    parser.add_argument('--embeddings',
                        ...
                        default=data_base2 + 'snli.npy')
    parser.add_argument('--train', help='JSONL or TSV file with training corpus',default=data_base2+'train_s1_s2_label.txt')#train_s1_s2_label.txt')#'train_lemma_wordpairs.txt')#'cnli_train_beta1_seg.txt')
    parser.add_argument('--validation',
                        help='JSONL or TSV file with validation corpus',default=data_base2+'dev_s1_s2_label.txt')#dev_s1_s2_label.txt')
    parser.add_argument('--test',
                        help='JSONL or TSV file with validation corpus',default=data_base2+'dev_s1_s2_label.txt')#breaknli_test.txt')
    parser.add_argument('--save', help='Directory to save the model files',default=root_base+"/model_weights/DAM_mlp/")
    ...
    parser.add_argument('--vocab', help='Vocabulary file (only needed if numpy'
                                        'embedding file is given)',default=data_base2+'vocab.txt')#new_vocab.txt')
