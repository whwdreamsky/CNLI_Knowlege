...
class KIMClassifier(DecomposableNLIModel):
    """
    ...
    """
    def __init__(self, num_units, num_classes, vocab_size, embedding_size, wordweightdict=None, num_wordnetfeather=5,
                 training=True, project_input=True, optimizer='adagrad', use_intra_attention=False, distance_biases=10,
                 maxlen1=None, maxlen2=None,attendweight = 0.0):
        """
        ...
        super(KIMClassifier, self).\
            __init__(num_units, num_classes, vocab_size, embedding_size,wordweightdict,num_wordnetfeather,
    ...
    def _transformation_input(self, inputs, reuse_weights=False):
        ...
        """
        transformed = super(KIMClassifier, self).\
    ...
    def _get_params_to_save(self):
        params = super(KIMClassifier, self)._get_params_to_save()
